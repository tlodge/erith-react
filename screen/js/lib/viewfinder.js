...
var ActionTypes = ErithConstants.ActionTypes; var ypadding = 0;//state.height/15;
var horizdiv = 2.2;
var d3 = require('./d3');
...
var ViewFinder = {
  ...
  tags: function(){
	...
	var tagdata = [	{text:"happy", selected:false},
					{text:"sad", selected:false},
					{text:"shy", selected:false},
					{text: "angry", selected:false},
					{text:"quiet", selected:false},
